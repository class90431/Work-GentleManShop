  ...
  <div class="new">
    <loading :active.sync="isLoading"></loading>
      <div class="main">
        <div class="container">
          <div class="row px-3">
            <p class="font-weight-bold text-left">BOTTOM</p>
          </div>
          <div class="row d-flex justify-content-start">
            <div class="col-12 col-sm-4 card mb-5" style="width: 18rem;" v-for="(item, index) in bottom_Products" :key="index">
...
export default {
  ...
  computed: {
    ...mapGetters(['isLoading', 'tempProducts', 'bottom_Products'])
  },
  created () {
    this.getProducts()
  }
